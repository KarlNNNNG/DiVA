...
def main(doc_split):    
    ...
    if doc_split == "train":
        data_path = "D:\\Projects\\GenerativeRE\\dataset\\redocred\\data\\train_revised_preprocessed.json"
        save_dir = "D:\\Projects\\GenerativeRE\\dataset\\redocred\\data\\relation_docs_train"
    elif doc_split == "dev":
        data_path = "D:\\Projects\\GenerativeRE\\dataset\\redocred\\data\\test_revised_preprocessed.json"
        save_dir = "D:\\Projects\\GenerativeRE\\dataset\\redocred\\data\\relation_docs_test"
    elif doc_split == "test":
        data_path = "D:\\Projects\\GenerativeRE\\dataset\\redocred\\data\\dev_revised_preprocessed.json"
        save_dir = "D:\\Projects\\GenerativeRE\\dataset\\redocred\\data\\relation_docs_dev"
    else:

...
if __name__ == "__main__":
    data_path =  r"D:\Projects\GenerativeRE\dataset\redocred\data\dev_revised.json"
    ...
    #                                                 columns=["paragraph_id", "paragraph", "predicate_name", 
    #                                                         "subject_names", "object_names", "evidences"])
    write_path  = "D:\\Projects\\GenerativeRE\\dataset\\docred\\data\\relation_docs_dev.csv"
    ...
    path_doc = "dataset\\docred\\data\\dev_preprocessed.json"
    ...
    write_file = "dataset\\docred\\data\\embeddings_dev.pkl"

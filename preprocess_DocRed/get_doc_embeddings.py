...
if __name__ == "__main__":
	...
	#main("dataset\\docred\\data\\train_distant_preprocessed.json" ,  "dataset\\docred\\data\\embeddings_train_distant.pkl")
	#main("dataset\\docred\\data\\train_annotated_preprocessed.json" ,  "dataset\\docred\\data\\embeddings_train_annotated.pkl")
	main("dataset\\docred\\data\\dev_preprocessed.json" ,  "dataset\\docred\\data\\embeddings_dev.pkl")